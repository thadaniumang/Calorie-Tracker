    ...
    return (
        <>
            <div className="pt-2 mx-auto text-gray-600 relative">
                <input className="w-full border-2 border-gray-300 bg-white py-2 px-5 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Search For The Item You Had" />
                <button type="submit" className="absolute right-0 bottom-3 mx-4">
